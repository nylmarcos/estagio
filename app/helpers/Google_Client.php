...
require_once "srcoauth/config.php";
...
require_once 'srcoauth/service/Google_Model.php';
require_once 'srcoauth/service/Google_Service.php';
require_once 'srcoauth/service/Google_ServiceResource.php';
require_once 'srcoauth/auth/Google_AssertionCredentials.php';
require_once 'srcoauth/auth/Google_Signer.php';
require_once 'srcoauth/auth/Google_P12Signer.php';
require_once 'srcoauth/service/Google_BatchRequest.php';
require_once 'srcoauth/external/URITemplateParser.php';
require_once 'srcoauth/auth/Google_Auth.php';
require_once 'srcoauth/cache/Google_Cache.php';
require_once 'srcoauth/io/Google_IO.php';
require_once('srcoauth/service/Google_MediaFileUpload.php');
